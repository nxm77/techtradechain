...
import (
	...
	evm "techtradechain.com/techtradechain/common/v2/evmutils"
...
func main() {
	...
	mainFlags.StringVarP(&userKeyPath, "user-key", "k", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.tls.key", "specify user key path")
	mainFlags.StringVarP(&userCrtPath, "user-crt", "c", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.tls.crt", "specify user crt path")
	mainFlags.StringVarP(&caPathsString, "ca-path", "P", "../../config/crypto-config/wx-org1.techtradechain.com/ca,../../config/crypto-config/wx-org2.techtradechain.com/ca", "specify ca path")
	...
	//mainFlags.StringVar(&orgIds, "org-ids", "wx-org1,wx-org2,wx-org3,wx-org4", "orgIds of admin")
	mainFlags.StringVar(&adminSignKeys, "admin-sign-keys", "../../config/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.key,../../config/crypto-config/wx-org2.techtradechain.com/user/admin1/admin1.sign.key,../../config/crypto-config/wx-org3.techtradechain.com/user/admin1/admin1.sign.key,../../config/crypto-config/wx-org4.techtradechain.com/user/admin1/admin1.sign.key", "adminSignKeys of admin")
	mainFlags.StringVar(&adminSignCrts, "admin-sign-crts", "../../config/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.crt,../../config/crypto-config/wx-org2.techtradechain.com/user/admin1/admin1.sign.crt,../../config/crypto-config/wx-org3.techtradechain.com/user/admin1/admin1.sign.crt,../../config/crypto-config/wx-org4.techtradechain.com/user/admin1/admin1.sign.crt", "adminSignCrts of admin")
