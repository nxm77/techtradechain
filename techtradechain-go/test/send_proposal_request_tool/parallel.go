...
func ParallelCMD() *cobra.Command {
	...
	flags.StringVarP(&userCrtPathsString, "user-crts", "K", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.tls.crt,../../config/crypto-config/wx-org2.techtradechain.com/user/client1/client1.tls.crt", "specify user crt path")
	flags.StringVarP(&userKeyPathsString, "user-keys", "u", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.tls.key,../../config/crypto-config/wx-org2.techtradechain.com/user/client1/client1.tls.key", "specify user key path")
