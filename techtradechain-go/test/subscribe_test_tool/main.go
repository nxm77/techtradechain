...
func main() {
	...
	mainFlags.StringVarP(&userKeyPath, "userkey", "k", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.tls.key", "specify user key path")
	...
	mainFlags.StringArrayVarP(&caPaths, "ca-path", "P", []string{"../../config/crypto-config/wx-org1.techtradechain.com/ca"}, "specify ca path")
	...
	mainFlags.StringVarP(&orgId, "org-id", "O", "wx-org1.techtradechain.com", "specify org id")
