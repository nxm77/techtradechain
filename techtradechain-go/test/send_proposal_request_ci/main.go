...
/*
sql rust test/wasm/rust-func-verify-2.0.0.wasm 源码所在目录：techtradechain-contract-sdk-rust - v2.0.0_dev - src/contract_functional_verify.rs
sql tinygo go-test/wasm/go-func-verify-2.0.0.wasm 源码所在目录：techtradechain-contract-sdk-tinygo - develop - demo/main_functional_verify.go
*/
package main
...
import (
	...
	"techtradechain.com/techtradechain/common/v2/evmutils/abi"
...
var caPaths = []string{certPathPrefix + "/crypto-config/wx-org1.techtradechain.com/ca"}
...
func runTest() {
	...
	if string(result) != "{\"file_hash\":\"b4018d181b6f\",\"file_name\":\"技术贸易链techtradechain\",\"time\":\"1615188470000\"}" {
...
const (
	...
	adminCrtPath = certPathPrefix + "/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.crt"
)
...
func nativeTest() {
	...
	if getResult != "技术贸易链techtradechain" {
