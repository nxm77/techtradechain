...
class Test(unittest.TestCase):
    def test_balance_a_compare_cert(self):
        ...
        for i in range(1,10):
            cd_asset.invoke("sql_insert",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\",\"age\":\"{}\",\"id_card_no\":\"{}\"}}".format(str(i),"techtradechain",str(i+10),"510623199202023323"))
        ...
        print("4.invoke sql sentence: update name=techtradechain_update where id=1".center(50, "="))
        cd_asset.invoke("sql_update",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(1),"techtradechain_update"))



        print("5.query if the name of id=1 update to techtradechain_update".center(50, "="))
        ...
        cd_asset.invoke("sql_insert",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\",\"age\":\"{}\",\"id_card_no\":\"{}\"}}".format(str(20),"techtradechain",str(2000),"510623199202023323"))

        print("10.1 commit a failed transaction".center(50, "="))
        cd_asset.invoke("sql_update_rollback_save_point",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(20),"techtradechain_save_point"))
        ...
        self.assertEqual(name, 'techtradechain', "success")
        ...
        cd_asset.invoke("sql_insert",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\",\"age\":\"{}\",\"id_card_no\":\"{}\"}}".format(str(21),"techtradechain",str(100000),"510623199202023323"))
        ...
        for i in range(500,600):
            ...
            cd_asset2.invoke("sql_insert",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\",\"age\":\"{}\",\"id_card_no\":\"{}\"}}".format(str(i),"techtradechain",str(i+10),"510623199202023323"))
        ...
        ddl_result=cd_asset.invoke("sql_execute_ddl",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
        ...
        forbidden_result=cd_asset.invoke("sql_dbname_table_name",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
        ...
        print("14.3 in SQL,forbid using transaction operation sentence,such as commit ,rollback,transaction is controlled by TechTradeChain framework.".center(50, "="))
        tx_result=cd_asset.invoke("sql_execute_commit",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
        ...
        random_key_result=cd_asset.invoke("sql_random_key",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
        ...
        random_str_result=cd_asset.invoke("sql_random_str",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(502),"techtradechain"))
        ...
        random_query_str_result=cd_asset.get("sql_random_query_str",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
        ...
        multi_sql_result=cd_asset.invoke("sql_multi_sql",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
        ...
        update_state_info_result=cd_asset.invoke("sql_update_state_info",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
        ...
        query_state_info_result=cd_asset.get("sql_query_state_info",sdk_config="sdk_config.yml",params="{{\"id\":\"{}\",\"name\":\"{}\"}}".format(str(501),"techtradechain"))
