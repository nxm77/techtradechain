...
#
VM_GO_IMAGE_NAME="techtradechainofficial/techtradechain-vm-engine:v2.3.5"
...
function start_vm_go() {
  ...
  xsed "s%enable: false%enable: true%g" ./config/wx-org$1.techtradechain.com/techtradechain.yml
...
start_vm_go 1 "./data/wx-org1.techtradechain.com/go" "./log/wx-org1.techtradechain.com/go" 32351 22351
start_vm_go 2 "./data/wx-org2.techtradechain.com/go" "./log/wx-org2.techtradechain.com/go" 32352 22352
start_vm_go 3 "./data/wx-org3.techtradechain.com/go" "./log/wx-org3.techtradechain.com/go" 32353 22353
start_vm_go 4 "./data/wx-org4.techtradechain.com/go" "./log/wx-org4.techtradechain.com/go" 32354 22354
sleep 3
