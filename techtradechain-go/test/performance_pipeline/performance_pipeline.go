...
var (
	caPaths = [][]string{
		{certPathPrefix + "wx-org1.techtradechain.com/ca/"},
		{certPathPrefix + "wx-org2.techtradechain.com/ca/"},
		{certPathPrefix + "wx-org3.techtradechain.com/ca/"},
		{certPathPrefix + "wx-org4.techtradechain.com/ca/"},
	}
	userKeyPaths = []string{
		certPathPrefix + "wx-org1.techtradechain.com/user/client1/client1.sign.key",
		certPathPrefix + "wx-org2.techtradechain.com/user/client1/client1.sign.key",
		certPathPrefix + "wx-org3.techtradechain.com/user/client1/client1.sign.key",
		certPathPrefix + "wx-org4.techtradechain.com/user/client1/client1.sign.key",
	}
	userCrtPaths = []string{
		certPathPrefix + "wx-org1.techtradechain.com/user/client1/client1.sign.crt",
		certPathPrefix + "wx-org2.techtradechain.com/user/client1/client1.sign.crt",
		certPathPrefix + "wx-org3.techtradechain.com/user/client1/client1.sign.crt",
		certPathPrefix + "wx-org4.techtradechain.com/user/client1/client1.sign.crt",
	}
	orgIds = []string{
