...
func prePathFmt() string {
	return certPathPrefix + "/crypto-config/wx-org%s.techtradechain.com/user/admin1/"
}
func userKeyPath() string {
	return certPathPrefix + "/crypto-config/wx-org1.techtradechain.com/user/client1/client1.sign.key"
}
func userCrtPath() string {
	return certPathPrefix + "/crypto-config/wx-org1.techtradechain.com/user/client1/client1.sign.crt"
}

func adminCrtPath() string {
	return certPathPrefix + "/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.crt"
}
