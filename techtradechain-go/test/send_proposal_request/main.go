...
const (
	...
	OrgIdFormat = "wx-org%d.techtradechain.com"
	tps         = 10000 //

	userKeyPathFormat  = certPathPrefix + "crypto-config/wx-org%d.techtradechain.com/user/client1/client1.sign.key"
	userCertPathFormat = certPathPrefix + "crypto-config/wx-org%d.techtradechain.com/user/client1/client1.sign.crt"
)
...
var (
	caPaths = [][]string{
		...
		{certPathPrefix + "crypto-config/wx-org5.techtradechain.com/ca"},
		{certPathPrefix + "crypto-config/wx-org6.techtradechain.com/ca"},
		{certPathPrefix + "crypto-config/wx-org7.techtradechain.com/ca"},
	}
	userKeyPaths = []string{
		...
		certPathPrefix + "crypto-config/wx-org5.techtradechain.com/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/wx-org6.techtradechain.com/user/client1/client1.sign.key",
		certPathPrefix + "crypto-config/wx-org7.techtradechain.com/user/client1/client1.sign.key",
	}
	userCrtPaths = []string{
		...
		certPathPrefix + "crypto-config/wx-org5.techtradechain.com/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/wx-org6.techtradechain.com/user/client1/client1.sign.crt",
		certPathPrefix + "crypto-config/wx-org7.techtradechain.com/user/client1/client1.sign.crt",
	}
	orgIds = []string{
