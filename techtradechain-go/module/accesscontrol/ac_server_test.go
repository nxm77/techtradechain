...
func TestValidateResourcePolicy(t *testing.T) {
	...
	acServices := initAccessControlService(testHashType, protocol.Identity, config.AddrType_TECHTRADECHAIN, nil, logger)
...
func TestCertInitData(t *testing.T) {
	...
	ac.createDefaultResourcePolicyForCert("wx-org.techtradechain.com")
...
func TestPwkInitData(t *testing.T) {
	...
	ac.createDefaultResourcePolicyForPWK("wx-org.techtradechain.com")
