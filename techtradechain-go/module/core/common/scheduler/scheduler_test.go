...
import (
	...
	crypto2 "techtradechain.com/techtradechain/common/v2/crypto"
...
func prepare(t *testing.T, enableSenderGroup, enableConflictsBitWindow bool, txCount int, setVM bool) (*mock.MockVmManager, []*commonPb.TxRWSet, []*commonPb.Transaction,
	*mock.MockSnapshot, protocol.TxScheduler, *commonPb.Contract, *commonPb.Block) {
	...
	chainConfig := &configpb.ChainConfig{
		...
		Vm: &configpb.Vm{
			AddrType: configpb.AddrType_TECHTRADECHAIN,
		},
...
func TestSchedule4(t *testing.T) {
	...
	localconf.TechTradeChainConfig.NodeConfig.PrivKeyFile = TestPrivKeyFile
	localconf.TechTradeChainConfig.NodeConfig.CertFile = TestCertFile
	localconf.TechTradeChainConfig.NodeConfig.PrivKeyPassword = "11111111"
