...
import (
	...
	bn "techtradechain.com/techtradechain/common/v2/birdsnest"
	sbn "techtradechain.com/techtradechain/common/v2/shardingbirdsnest"
...
func GetConf(chainId string) (*TxFilterConfig, error) {
	return ToPbConfig(localconf.TechTradeChainConfig.TxFilter, chainId)
}
