...
// localconf.TechTradeChainConfig.NodeConfig.FastSyncConfig.Enable used to determine
...
func (sch *scheduler) handleScheduleMsg() (queue.Item, error) {
	...
	var bsr = syncPb.BlockSyncReq{
		...
		WithRwset:   localconf.TechTradeChainConfig.NodeConfig.FastSyncConfig.Enable,
	}
...
func (sch *scheduler) handleSyncedBlockMsg(msg *SyncedBlockMsg) (queue.Item, error) {
	...
	sch.log.Debugf(
		...
		localconf.TechTradeChainConfig.NodeConfig.FastSyncConfig.Enable,
		blkBatch.WithRwset,
	)
