...
func initTestSync(t *testing.T) (protocol.SyncService, func()) {
	...
	log := &test.GoLogger{}
	// localconf.TechTradeChainConfig.SyncConfig.SchedulerTick = 10
	// localconf.TechTradeChainConfig.SyncConfig.ProcessBlockTick = 10
...
//	localconf.TechTradeChainConfig.NodeConfig.FastSyncConfig.Enable = true
//	service, fn := initTestSync(t)
//	defer fn()
//	implSync := service.(*BlockChainSyncServer)
//	// modify config for a stable unit test result
...
func TestBlockChainSyncServer_OnMessage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			localconf.TechTradeChainConfig.SyncConfig.BroadcastStatusPerBlocksCommitted = tt.args.perBlocks
