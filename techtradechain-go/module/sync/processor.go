...
func (pro *processor) handleReceivedBlockInfos(msg *ReceivedBlockInfos) {
	...
	// block message implied in techtradechain version <= 2.1.x
	...
	// block message implied in techtradechain version == 2.2.x
...
func (pro *processor) handleProcessBlockMsg() (queue.Item, error) {
	...
	if info.withRWSets && localconf.TechTradeChainConfig.NodeConfig.FastSyncConfig.Enable {
