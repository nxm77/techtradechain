...
func getRateLimitBucket(bucketMap *sync.Map, tokenBucketSize, tokenPerSecond int, peerIpAddr string) *rate.Limiter {
	rateLimitType := localconf.TechTradeChainConfig.RpcConfig.RateLimitConfig.Type
	var (
		bucket interface{}
		ok     bool
	)
...
func RateLimitInterceptor() grpc.UnaryServerInterceptor {
	...
	tokenBucketSize := localconf.TechTradeChainConfig.RpcConfig.RateLimitConfig.TokenBucketSize
	tokenPerSecond := localconf.TechTradeChainConfig.RpcConfig.RateLimitConfig.TokenPerSecond
	enabled := localconf.TechTradeChainConfig.RpcConfig.RateLimitConfig.Enabled
...
func BlackListInterceptor() grpc.UnaryServerInterceptor {
	...
	blackIps := localconf.TechTradeChainConfig.RpcConfig.BlackList.Addresses
