...
import (
	...
	msgbusMock "techtradechain.com/techtradechain/common/v2/msgbus/mock"
...
var (
  ...
  //UserSignKeyPathFmt  = certPathPrefix + "/crypto-config/wx-org%s.techtradechain.com/user/light1/light1.sign.key"
  //UserSignCrtPathFmt  = certPathPrefix + "/crypto-config/wx-org%s.techtradechain.com/user/light1/light1.sign.crt"
  ...
  // caPaths    = []string{"D:/develop/workspace/techTradeChain/techtradechain-go/build/crypto-config/wx-org5.techtradechain.com/ca"}
