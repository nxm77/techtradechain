...
func TestInitNet(t *testing.T) {
	t.Log("TestInitNet")
	techtradechainServerList := makeChainServer(t)

	for _, server := range techtradechainServerList {
		err := server.initNet()
...
func TestDeleteBlockchainTaskListener(t *testing.T) {
	...
	techtradechainServerList := makeChainServer(t)
	techtradechainServerList[0].blockchains.Store("chain1", &Blockchain{
		chainId: "chain1",
	})
	techtradechainServerList[0].blockchains.Store("chain1", &Blockchain{
		chainId: "chain2",
	})
	go techtradechainServerList[0].deleteBlockchainTaskListener()
...
func TestNewBlockchainTaskListener(t *testing.T) {
	...
	go techtradechainServerList[0].newBlockchainTaskListener()
...
/*func TestInitBlockchain(t *testing.T)  {
	...
	err := techtradechainServer.initBlockchain("12344", "666")
...
/*func TestNewBlockchainTaskListener(t *testing.T)  {
	...
	techtradechainServer := TechTradeChainServer{}
	techtradechainServer.newBlockchainTaskListener()
	timer := time.NewTimer(3 * time.Second)
	<-timer.C
}*/

//func TestTechTradeChainServer_initBlockchain(t *testing.T) {
//	type fields struct {
//		net         protocol.Net
...
func TestTechTradeChainServer_StartForRebuildDbs(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_Start(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_Stop(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_AddTx(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetStore(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetChainConf(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetAllChainConf(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetVmManager(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetEventSubscribe(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetNetService(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetBlockchain(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_GetAllAC(t *testing.T) {
	type fields struct {
		net    protocol.Net
		readyC chan struct{}
	}
...
func TestTechTradeChainServer_Version(t *testing.T) {
	type fields struct{}
	tests := []struct {
		name   string
		fields fields
...
func makeChainServer(t *testing.T) []*TechTradeChainServer {

	serverList := make([]*TechTradeChainServer, 0)
	for i := 0; i < 4; i++ {
		var (
		...
		//net.EXPECT().Start().AnyTimes().Return(nil)
		//net.EXPECT().Stop().AnyTimes().Return(nil)
		techTradeChain := &TechTradeChainServer{
			net:         net,
			blockchains: sync.Map{},
			//readyC: struct {}<-,
		}

		err := techTradeChain.Init()

		if err != nil {
			t.Log(err)
		}

		serverList = append(serverList, techTradeChain)
	}
