            ...
            do
                ...
                if  [ $c -eq $i ]; then
                    if [ $c -gt $NODE_CNT ]; then
                      xsed "s%{node_pk_path}%node\/common1\/common1%g" node$i/techtradechain.yml
                      xsed "s%{net_pk_path}%node\/common1\/common1%g" node$i/techtradechain.yml
                    else
                      xsed "s%{node_pk_path}%node\/consensus1\/consensus1%g" node$i/techtradechain.yml
                      xsed "s%{net_pk_path}%node\/consensus1\/consensus1%g" node$i/techtradechain.yml
                    fi
