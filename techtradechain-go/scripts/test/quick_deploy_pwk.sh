...
function cmc_test() {
  ...
  ./cmc client contract user create \
    ...
    --admin-org-ids=wx-org1.techtradechain.com,wx-org2.techtradechain.com,wx-org3.techtradechain.com,wx-org4.techtradechain.com \
    --admin-key-file-paths=./testdata/crypto-config/wx-org1.techtradechain.com/admin/admin.key,./testdata/crypto-config/wx-org2.techtradechain.com/admin/admin.key,./testdata/crypto-config/wx-org3.techtradechain.com/admin/admin.key,./testdata/crypto-config/wx-org4.techtradechain.com/admin/admin.key \
    --sync-result=true \
    --params="{}"
