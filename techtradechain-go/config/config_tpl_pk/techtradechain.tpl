...
# "auth_type" should be consistent among the whole chain configuration files(e.g., bc1.yml and techtradechain.yml)
...
storage:
  ...
  blockdb_config:
    ...
    # badgerdb_config:
      # BadgerDb store path
      # store_path: ../data/wx-org1.techtradechain.com/history
    ...
    # tikvdb_config:
      ...
      # grpc_connection_count: 16 # techtradechain and tikv connect count, default: 4
...
vm:
  ...
  go:
    ...
    # Mount data path in techtradechain, include contracts, uds socks
    data_mount_path: ../data/{org_id}/go

    # Mount log path in techtradechain
    log_mount_path: ../log/{org_id}/go

    # Communication protocol, used for techtradechain and docker manager communication
    ...
    # Priority: techtradechain.yml > vm.yml > default settings
