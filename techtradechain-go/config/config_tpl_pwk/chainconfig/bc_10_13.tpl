...
# The blockchain auth type, shoudle be consistent with auth type in node config (e.g., techtradechain.yml)
...
contract:
  ...
  # If it is true, storage.statedb_config.provider in techtradechain.yml should be sql.
...
vm:
  #0:techtradechain, 1:zxl, 2:ethereum
  addr_type: 2
  # support vm list
  support_list:
    - "wasmer"
