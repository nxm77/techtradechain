...
type netConfig struct {
	...
	SeedTargetAddressList   []string          `mapstructure:"seed_target_address_list"`
...
type rpcConfig struct {
	...
	SyncTxResultTimeout                    int              `mapstructure:"sync_tx_result_timeout"`
}
...
type tlsConfig struct {
	...
	ClientRootCaPaths     []string `mapstructure:"client_root_ca_paths"`
}
...
func (c *CMConfig) Deal() {
	...
	if c.RpcConfig.SyncTxResultTimeout <= 0 {
		c.RpcConfig.SyncTxResultTimeout = DefaultRpcSyncTxResultTimeout
	}
}
