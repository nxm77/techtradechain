...
func (o senderOrgId) Execute(input []byte, version uint32, ctx *environment.Context) ([]byte, error) {
	return input, nil
}
...
func (o senderRole) Execute(input []byte, version uint32, ctx *environment.Context) ([]byte, error) {
	return input, nil
}
...
func (o senderPk) Execute(input []byte, version uint32, ctx *environment.Context) ([]byte, error) {
	return input, nil
}
...
func (o creatorOrgId) Execute(input []byte, version uint32, ctx *environment.Context) ([]byte, error) {
	return input, nil
}
...
func (o creatorRole) Execute(input []byte, version uint32, ctx *environment.Context) ([]byte, error) {
	return input, nil
}
...
func (o creatorPk) Execute(input []byte, version uint32, ctx *environment.Context) ([]byte, error) {
	return input, nil
}
