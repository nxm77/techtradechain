...
3. 使用实例
   ...
   * 实例1
   ...
   ```
    l, err := Open("/root/go/src/techtradechain.com/lws/log", WithSegmentSize(30), WithFilePrex("test_"), WithWriteFlag(WF_SYNCFLUSH, 0), WithFileLimitForPurge(3))
    if err != nil {
        return err
    }
   ...
   * 实例2
   ...
   ```
    ...
    l, err := Open("/root/go/src/techtradechain.com/lws/log", WithSegmentSize(30), WithFilePrex("test_"))
    require.Nil(t, err)
