module techtradechain.com/techtradechain/consensus-maxbft/v2
...
require (
	...
	techtradechain.com/techtradechain/lws v1.2.1
...
require (
	techtradechain.com/techtradechain/logger/v2 v2.4.0 // indirect
