...
import (
	...
	"techtradechain.com/techtradechain/consensus-maxbft/v2/status"
	"techtradechain.com/techtradechain/consensus-maxbft/v2/utils"
	timeservice "techtradechain.com/techtradechain/consensus-utils/v2/time_service"
	...
	chainUtils "techtradechain.com/techtradechain/utils/v2"
...
func (e *Engine) handleOtherViewProposal(proposal *maxbft.ProposalData) {
	...
	e.processQC(qc, header.GetBlockVersion())
}
...
func (e *Engine) processQC(qc *maxbft.QuorumCert, blockVersion uint32) {
	if err := e.validator.ValidateQc(qc, blockVersion); err != nil {
...
func (e *Engine) handleVote(vote *maxbft.VoteData) {
	...
	e.processQC(qc, blockNode.Data().Proposal().GetBlock().GetHeader().GetBlockVersion())
}
