...
import (
	...
	"techtradechain.com/techtradechain/net-liquid/relay/pb"
	...
	"techtradechain.com/techtradechain/net-liquid/core/blacklist"
...
// UnNotify unregisters a Notifiee to host.
func (bh *BasicHost) UnNotify(notifiee host.Notifiee) {
	bh.notifiee.Delete(notifiee)
}
