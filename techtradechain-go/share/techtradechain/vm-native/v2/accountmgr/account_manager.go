...
func registerGasAccountContractMethods(log protocol.Logger) map[string]common.ContractFunc {
	...
	methodMap[syscontract.GasAccountFunction_SET_CONTRACT_METHOD_PAYER.String()] = common.WrapResultFunc(
		gasAccountRuntime.setMethodPayer)
	methodMap[syscontract.GasAccountFunction_UNSET_CONTRACT_METHOD_PAYER.String()] = common.WrapResultFunc(
		gasAccountRuntime.unsetMethodPayer)
	methodMap[syscontract.GasAccountFunction_GET_CONTRACT_METHOD_PAYER.String()] = common.WrapResultFunc(
		gasAccountRuntime.getMethodPayer)
	methodMap[syscontract.GasAccountFunction_GET_TX_PAYER.String()] = common.WrapResultFunc(
		gasAccountRuntime.getTxPayer)
