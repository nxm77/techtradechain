...
import "techtradechain.com/techtradechain/store/v2/serialization"
...
type RollingWindowCache interface {
	...
	// @param key
	// @param start
	// @return uint64 start在滑动窗口内的情况，0 小于左边，1 处于窗口内，2 大于右边 ;
	// @return bool key是否存在
	// @return error
	Has(key string, start uint64) (uint64, bool, error)
