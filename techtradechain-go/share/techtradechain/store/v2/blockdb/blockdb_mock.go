...
func (mr *MockBlockDBMockRecorder) GetDbType() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDbType", reflect.TypeOf((*MockBlockDB)(nil).GetDbType))
}

// CompactRange mocks base method.
func (m *MockBlockDB) CompactRange() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CompactRange")
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockBlockDBMockRecorder) CompactRange() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CompactRange", reflect.TypeOf((*MockBlockDB)(nil).CompactRange))
}
...
func (mr *MockBlockDBMockRecorder) ShrinkBlocks(startHeight, endHeight, bfdbPath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ShrinkBlocks", reflect.TypeOf((*MockBlockDB)(nil).ShrinkBlocks), startHeight, endHeight, bfdbPath)
}
