...
import (
	...
	sdkPbAc "techtradechain.com/techtradechain/pb-go/v2/accesscontrol"
	sdkPbCommon "techtradechain.com/techtradechain/pb-go/v2/common"
)
...
func signCMD() *cobra.Command {
	...
	flags.StringVarP(&orgId, "org-id", "O", "wx-org1.techtradechain.com", "specify organization identity")
