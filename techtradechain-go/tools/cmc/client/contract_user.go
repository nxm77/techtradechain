...
import (
	...
	"techtradechain.com/techtradechain-go/tools/cmc/types"
...
// --admin-key-file-paths=./testdata/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.key
// --admin-crt-file-paths=./testdata/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.crt
// --sync-result=true \
// --params="{}"
