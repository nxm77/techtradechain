...
// alterAddrTypeCMD alter addr type, eg. TechTradeChain type, ZXL type etc.
// @return *cobra.Command
func alterAddrTypeCMD() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "alter-addr-type",
		Short: "alter addr type, eg. TechTradeChain type, ZXL type etc.",
		Long:  "alter addr type, eg. TechTradeChain type, ZXL type etc.",
