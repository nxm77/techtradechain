...
import (
	...
	sdk "techtradechain.com/techtradechain/sdk-go/v2"
...
func ParallelCMD() *cobra.Command {
	...
	flags.StringVarP(&signCrtPathsString, "sign-crts", "K", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.sign.crt,../../config/crypto-config/wx-org2.techtradechain.com/user/client1/client1.sign.crt", "specify user crt path")
	flags.StringVarP(&signKeyPathsString, "sign-keys", "u", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.sign.key,../../config/crypto-config/wx-org2.techtradechain.com/user/client1/client1.sign.key", "specify user key path")
	flags.StringVar(&userCrtPathsString, "user-crts", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.tls.crt,../../config/crypto-config/wx-org2.techtradechain.com/user/client1/client1.tls.crt", "specify tls crt path")
	flags.StringVar(&userKeyPathsString, "user-keys", "../../config/crypto-config/wx-org1.techtradechain.com/user/client1/client1.tls.key,../../config/crypto-config/wx-org2.techtradechain.com/user/client1/client1.tls.key", "specify tls key path")
	...
	flags.StringVarP(&caPathsString, "ca-path", "P", "../../config/crypto-config/wx-org1.techtradechain.com/ca,../../config/crypto-config/wx-org2.techtradechain.com/ca", "specify ca path")
	...
	flags.StringVar(&adminSignKeys, "admin-sign-keys", "../../config/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.key,../../config/crypto-config/wx-org2.techtradechain.com/user/admin1/admin1.sign.key,../../config/crypto-config/wx-org3.techtradechain.com/user/admin1/admin1.sign.key,../../config/crypto-config/wx-org4.techtradechain.com/user/admin1/admin1.sign.key", "adminSignKeys of admin")
	flags.StringVar(&adminSignCrts, "admin-sign-crts", "../../config/crypto-config/wx-org1.techtradechain.com/user/admin1/admin1.sign.crt,../../config/crypto-config/wx-org2.techtradechain.com/user/admin1/admin1.sign.crt,../../config/crypto-config/wx-org3.techtradechain.com/user/admin1/admin1.sign.crt,../../config/crypto-config/wx-org4.techtradechain.com/user/admin1/admin1.sign.crt", "adminSignCrts of admin")
	...
	flags.Uint32Var(&authTypeUint32, "auth-type", 1, "techtradechain auth type. PermissionedWithCert:1,PermissionedWithKey:2,Public:3")
