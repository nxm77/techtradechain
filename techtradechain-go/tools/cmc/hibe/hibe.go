...
import (
	...
	"techtradechain.com/techtradechain/common/v2/crypto/hibe"
)
...
// HibeCMD new TechTradeChain hibe command
func HibeCMD() *cobra.Command {
	hibeCmd := &cobra.Command{
		Use:   "hibe",
		Short: "TechTradeChain hibe command",
		Long:  "TechTradeChain hibe command",
	}
