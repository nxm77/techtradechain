...
var (
	sans = []string{"localhost", "techtradechain.com", "127.0.0.1"}
)

// CertCMD new TechTradeChain cert command
func CertCMD() *cobra.Command {
	certCmd := &cobra.Command{
		Use:   "cert",
		Short: "TechTradeChain cert command",
		Long:  "TechTradeChain cert command",
	}
