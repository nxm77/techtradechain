...
// NewConsoleCMD new Open a console to interact with TechTradeChain daemon command
func NewConsoleCMD(rootCmd *cobra.Command) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "console",
		Short: "Open a console to interact with TechTradeChain daemon",
		Long:  "Open a console to interact with TechTradeChain daemon",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			console := &CobraPrompt{
				...
				GoPromptOptions: []prompt.Option{
					prompt.OptionTitle("Interactive TechTradeChain Client"),
					prompt.OptionPrefix(">>> "),
