...
import (
	...
	bcDilithium "techtradechain.com/techtradechain/common/v2/crypto/asym/dilithium"

	"github.com/btcsuite/btcd/btcec"

	bccrypto "techtradechain.com/techtradechain/common/v2/crypto"
	"techtradechain.com/techtradechain/common/v2/crypto/asym"
	bcecdsa "techtradechain.com/techtradechain/common/v2/crypto/asym/ecdsa"
	bcrsa "techtradechain.com/techtradechain/common/v2/crypto/asym/rsa"
	bcsm2 "techtradechain.com/techtradechain/common/v2/crypto/asym/sm2"
...
// SignatureAlgorithm type define
...
var (
	...
	//oidSignatureDilithium2WithSHAKE256 is a self-defined oid for post-quantum Dilithium2
	// Be careful, this is not stable, compatibility is not guaranteed
	oidSignatureDilithium2WithSHAKE256 = asn1.ObjectIdentifier{1, 2, 840, 20000, 1, 1}
)
...
var signatureAlgorithmDetails = []struct {
	...
	{SHAKE256WithDilithium2, "SHAKE256-Dilithium2", oidSignatureDilithium2WithSHAKE256, Dilithium2,
		crypto.Hash(bccrypto.HASH_TYPE_SHA3_256)},
}
...
var (
	...
	oidPublicKeyDilithium2 = asn1.ObjectIdentifier{1, 2, 840, 20000, 2, 1}
)
...
func parsePublicKey(algo PublicKeyAlgorithm, keyData *publicKeyInfo) (bccrypto.PublicKey, error) {
	...
	case SM2:
		...
		return &bcsm2.PublicKey{K: pk}, nil
	case Dilithium2:
		return &bcDilithium.PublicKey{K: asn1Data, Dlt: dilithium.NewDilithium2()}, nil
...
func TechTradeChainCertToX509Cert(cert *Certificate) (*x509.Certificate, error) {
...
func X509CertToTechTradeChainCert(cert *x509.Certificate) (*Certificate, error) {
...
func signingParamsForPublicKey(pub interface{},
	...
	case *bcDilithium.PublicKey:
		pubType = Dilithium2
		hashFunc = crypto.Hash(bccrypto.HASH_TYPE_SHA256)
		sigAlgo.Algorithm = oidSignatureDilithium2WithSHAKE256
	...
	for _, details := range signatureAlgorithmDetails {
		if details.algo == requestedSigAlgo {
			// SHAKE256WithDilithium2 cert is signed by ECDSAWithSHA256 ca cert
			//TODO remove this when PQC-TLS implemented
			if requestedSigAlgo == SHAKE256WithDilithium2 && pubType == ECDSA {
				found = true
...
func marshalPublicKey(pub interface{}) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *bcDilithium.PublicKey:
		...
		if err != nil {
			return nil, pkix.AlgorithmIdentifier{}, errors.New("x509: marshal dilithium public key failed, err = " + err.Error())
		}
...
// nolint: staticcheck
func TechTradeChainCertCsrToX509CertCsr(cert *CertificateRequest) (*x509.CertificateRequest, error) {
...
// nolint: staticcheck
func X509CertCsrToTechTradeChainCertCsr(cert *x509.CertificateRequest) (*CertificateRequest, error) {
